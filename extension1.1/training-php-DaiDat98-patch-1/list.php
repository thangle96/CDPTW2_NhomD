...
$mh_string=base64_decode('ahAwByzlO');
$results = [];
$item_per_page = 3; 
                ...
                <tbody>
                    ...
                    <tr scope="row">
                        ...
                        <td> <a class="btn btn-primary"
                                href="list.php?list=<?php echo base64_encode(base64_encode(base64_encode($result['id']))).base64_encode('ahAwByzlO')?>"
                                onclick="return confirm('Bạn có muốn xóa thông tin thành viên này không')">Xóa</a>
                        </td>
                        <td>
                            <a class="btn btn-primary"
                                href="edit.php?edit=<?php echo base64_encode(base64_encode(base64_encode($result['id']))).base64_encode('ahAwByzlO')?>">Sửa</a>
                        </td>
                        <td> <a class="btn btn-primary"
                                href="details.php?id=<?php echo base64_encode(base64_encode(base64_encode($result['id']))).base64_encode('ahAwByzlO')?>">Chi
                                tiết</a>
                        </td>
                    </tr>
                    <?php endforeach; ?>
